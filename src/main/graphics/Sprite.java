...
public class Sprite {
    ...
    public static final int DEFAULT_SIZE = PropertiesConstant.TILE_SIZE;
    public static final int SCALED_SIZE = DEFAULT_SIZE * PropertiesConstant.SCALE;
    ...
    public static Sprite player_left = new Sprite(DEFAULT_SIZE, 3, 0, SpriteSheet.tiles, 10, 16);
    ...
    public static Sprite player_dead2 = new Sprite(DEFAULT_SIZE, 5, 2, SpriteSheet.tiles, 13, 16);
    ...
    |--------------------------------------------------------------------------
     */
    public static Sprite bomb = new Sprite(DEFAULT_SIZE, 0, 3, SpriteSheet.tiles, 15, 16);
    public static Sprite bomb_1 = new Sprite(DEFAULT_SIZE, 1, 3, SpriteSheet.tiles, 13, 16);
    public static Sprite bomb_2 = new Sprite(DEFAULT_SIZE, 2, 3, SpriteSheet.tiles, 12, 16);
    ...
    public Image getFxImage(int xSize, int ySize) {
        WritableImage wr = new WritableImage(xSize, ySize);
        PixelWriter pw = wr.getPixelWriter();
        for (int x = 0; x < xSize; x++) {
            for (int y = 0; y < ySize; y++) {
                if (_pixels[x + y * ySize] == TRANSPARENT_COLOR) {
                    pw.setArgb(x, y, 0);
                } else {
                    pw.setArgb(x, y, _pixels[x + y * ySize]);
                }
            }
        }
        Image input = new ImageView(wr).getImage();
